                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  ...
                                  child: StreamBuilder<String>(
                                      stream:
                                          selectedIconStreamController.stream,
                                      builder: (context, snapshot) {
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                          color:
                                              theme.textBlack.withOpacity(0.08),
                                          blurRadius: 16,
